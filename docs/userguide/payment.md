...
<tbody>
  <tr>
    <td rowspan="10">Клауд виртуал сервер</td>
    <td>vCPU</td>
    <td>1</td>
    <td>12'000</td>
  </tr>
...
:::info Мэдээлэл
- vCPU болон vRAM-ний төлбөр нь ажилласан цагаар бодогддог ба та тухайн серверийг унтраасан тохиолдолд төлбөр бодогдохгүй.
- Snapshot, Backup нөөцлөлт болон виртуал дискний төлбөр нь ашиглаж буй хэмжээнээсээ хамаарч сарын төлбөр бодогдоно.
- ***2 ба түүнээс дээш** - Нэг серверт залгагдсан Public IP хаяг нь 2 ба түүнээс дээш тохиолдолд эхний хаягийг 5'000₮ бодож 2 ба түүнээс дээш хаягийг тус бүр 30'000₮ бодогдоно.
:::
